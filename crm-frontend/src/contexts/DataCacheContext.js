...
export const DataCacheProvider = ({ children }) => {
  ...
  //
  // `?includeDropped=true` is intentional — the cache holds the FULL
  // roster so headline counts (e.g. the Dashboard's Inactive Clients
  // card, which rolls dropped + paused together) can include them.
  // Pages that shouldn't show dropped clients in their charts / lists /
  // dropdowns filter them out per-feature. The Clients management
  // page additionally bypasses this cache and fetches the same URL
